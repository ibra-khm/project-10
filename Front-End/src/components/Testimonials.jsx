    ...
    >
      ...
      >
        <div className="max-w-xl text-center sm:text-left">
          ...
          <div className="hidden lg:mt-8 lg:flex lg:gap-4">
            ...
            <button
              className="next-button rounded-full border border-brand p-3 text-brand hover:bg-brand hover:border-brand hover:text-white"
            >
      ...
      <div className="mt-8 flex justify-center gap-4 lg:hidden">
        <button
          ...
          className="prev-button rounded-full border border-brand p-4 text-brand hover:bg-brand hover:text-white"
        >
          <svg
            className="h-5 w-5 -rotate-180 transform"
            fill="none"
        ...
        <button
          ...
          className="next-button rounded-full border border-brand p-4 text-brand hover:bg-brand hover:text-white"
        >
          <svg
            className="h-5 w-5"
            fill="none"
