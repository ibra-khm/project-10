        ...
        <div className="text-center sm:text-left">
          ...
          <nav aria-label="Footer About Nav" className="mt-8">
            <ul className="space-y-4 text-sm">
              <li>
                <a
                  className="text-gray-700 transition hover:text-brand"
                  href="/"
                >
                  Company History
                </a>
          ...
          <nav aria-label="Footer Helpful Nav" className="mt-8">
            <ul className="space-y-4 text-sm">
              ...
              <li>
                ...
                >
                  <span
                    className="text-gray-700 transition group-hover:text-brand"
                  >
                    Live Chat
                  </span>
          ...
          <div className="mx-auto mt-8 max-w-md sm:ml-0">
            ...
            <form className="mt-4">
              ...
              >
                ...
                <input
                  className="w-full rounded-full border-gray-200 focus:ring-brand focus:border-brand px-6 py-3 shadow-sm"
                  type="email"
                  placeholder="Enter your email"
                />
  
                <button
                  className="block rounded-full bg-brand px-8 py-3 font-medium text-white transition hover:bg-yellow-400"
                  type="submit"
                >
                  Subscribe
                </button>
