        ...
        <div className="max-w-xl lg:max-w-3xl">
          ...
          <div className="col-span-6">
            <div className="hidden lg:relative lg:block lg:pb-12">
              ...
              <p className="mt-4 leading-relaxed text-black/90">
                Sign in to save your vehicles, track your orders and earn
                Rewards while you Shop.
              </p>
            </div>
          ...
          <div className="col-span-6 sm:col-span-3">
            ...
            <Input
              ...
              id="Password"
              name="password"
              className="mt-1 mb-1 w-full rounded-md border-none border-gray-300 bg-white text-sm text-gray-700 shadow-sm"
            />
