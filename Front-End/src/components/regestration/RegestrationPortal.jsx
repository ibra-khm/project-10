...
export default function RegistrationPortal() {
  ...
  return ReactDOM.createPortal(
    <>
      {showPortal ? (
        <div className="w-full h-full z-50  fixed inset-0 flex justify-center items-center backdrop-blur-sm   ">
          <Card
            data-aos="fade-up  "
          ...
          >
            ...
            <CardFooter className="pt-0">
              {form ? (
                <>
                  <button onClick={loginFun} className='w-full p-3 bg-blue-500 hover:bg-brand duration-300 transform ease-in-out text-white font-bold text-lg rounded-lg'>
                    Login
                  </button>
                </>
              ) : (
              ...
              <button className="w-full bg-gray-300 rounded-lg p-3"
                onClick={() => {
...
//           Sign in to save your vehicles, track your orders and earn Rewards
//           while you Shop.
//         </p>
//       </div>
